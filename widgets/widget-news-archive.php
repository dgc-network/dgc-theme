 ...
 */
class DGC_News_Archive_Widget extends WP_Widget {
	/**
	 * Constructor
	 *
	 * @return void
...
// register widget
if (!function_exists('dgc_news_archive_widget')) {
	function dgc_news_archive_widget() {
		register_widget('DGC_News_Archive_Widget');
	}
	add_action('widgets_init', 'dgc_news_archive_widget');
}
