...
class dgc_Widget_News_Archive extends WP_Widget {
	 ...
	 **/
	 public function __construct() {
		...
		$widget_name = $theme_name.' '.__( 'News Archive', 'dgc-wordpress-theme' );
		
		parent::__construct( 'widget_news_archive', $widget_name, array(
			'classname'   => 'widget_news_archive',
			'description' => __( 'Use this widget to list your Link posts.', 'dgc-wordpress-theme' ),
		) );
	}
	/**
	...
	public function widget( $args, $instance ) {
		...
		$title 			= apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'News-Archive', 'dgc-wordpress-theme' ) : $instance['title'], $instance, $this->id_base);
...
?>
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'dgc-wordpress-theme' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

			<p><label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of posts to show:', 'dgc-wordpress-theme' ); ?></label>
			<input id="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'number' ) ); ?>" type="text" value="<?php echo esc_attr( $number ); ?>" size="3" /></p>
			
			
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'textarea_newsarchiv' ) ); ?>"><?php _e( 'Text Message:', 'dgc-wordpress-theme' ); ?></label>
