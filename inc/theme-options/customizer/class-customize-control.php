...
class dgc_Customize_Textarea_Control extends WP_Customize_Control {
...
class dgc_Customize_Select_Control extends WP_Customize_Control {
	public $type 			= 'select';
	public $info			= ''; 
	public $top_label		= ''; 
	public $top_info		= ''; 	
...
class dgc_Customize_Font_Control extends WP_Customize_Control {
	public $type 		= 'font';
	public $info		= ''; 
	public $top_label	= ''; 
	public $top_info	= ''; 	
