...
class dgc_theme_options_customizer {
	...
	public function settings_fields () {
		global $dgc_ons;
		$this->sections = $dgc_ons->settings_fields();
	}

	public function register_settings ($wp_customize) {
		global $dgc_ons;
		$opt_name = $dgc_ons->args['opt_name'];	
		$theme_options  = dgc_options();
...
global $dgc_ons_customizer;	
$dgc_ons_customizer = new dgc_tdgc_odgc_izer();
