 ...
 *
 * This call to register_setting() registers a validation callback, dgc__options_validate(),
...
class dgc__options {
	...
	public function __construct() {
		...
		add_action( 'admin_bar_menu', array( $this, 'dgc_ustom_link_options' ), 1000 );
	}
	...
	public function setArguments() {
		$this->args = array(
			'opt_name'  => 'dgc__options', // Database option
			'opt_group' => 'dgc_ns',         // Options group
	...
	public function add_menu_item() {
		...
		*/
		$admin_page = add_theme_page(
			...
			array( &$this, 'dgc__options_render_page' )    // Function that renders the options page
		);
		add_action( 'admin_print_scripts-' . $admin_page, array( &$this, 'settings_assets' ) );
	}

	public function dgc_ustom_link_options() {
	 ...
	 * @since Fruitful theme 1.0
	 */
	public function dgc__options_render_page() {
		?>
        <div class="wrap">
            <h2></h2>
            <form method="post" action="/" enctype="multipart/form-data" class="form-admin-fruitful"
                ...
                <div class="content">
					...
					dgc_m_do_settings_sections( $this->args['opt_slug'] );
					?>
                ...
                <input type="hidden" name="action" value="dgc__options_action"/>
                <input type="hidden" name="security" value="<?php echo wp_create_nonce( 'dgc__data' ); ?>"/>
            </form>
