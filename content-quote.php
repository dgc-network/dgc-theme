...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog_post'); ?>>
	...
	<div class="post-content">	
		<header class="post-header">
			<h2 class="post-title entry-title"><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'dgc' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
		...
		<footer class="entry-meta">
			...
			<?php if ( comments_open() && ! is_single() ) : ?>
				<span class="comments-link">
					<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a comment', 'dgc' ) . '</span>', __( 'One comment so far', 'dgc' ), __( 'View all % comments', 'dgc' ) ); ?>
				</span><!-- .comments-link -->
